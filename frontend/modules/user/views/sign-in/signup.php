        ...
        <div class="col-sm-4">
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <?php echo $form->field($model, 'phone_number')->widget(\yii\widgets\MaskedInput::className(), [
                        'name' => 'Телефон',
                    ...
                    <div class="form-group">
                        <?php echo Html::submitButton('Зарегистрироваться', ['class' => 'btn btn-primary btn-lg btn-block', 'name' => 'signup-button']) ?>
                    </div>
                </div>
            </div>
